 ...
 * 서비스는 직접 로직을 수행하지는 않으며 모델 영역의 각 업무를 수행하는 객체를 제어하는 역할
 * 만일 Service의 존재가 없다면  컨트롤러가 모델영역의 복잡한 처리를 직접해야 하므로 어플리케이션 설계상의 영역 구분이
 * 약해지게 된다.
 * */
@Service
public class JdbcEmpService {
	...
	public List selectAll() {
		...
		jdbcEmpDAO.setCon(con);//Connection주입
