...
<%@page import="com.sun.tools.javac.api.Formattable"%>
...
<script>
 function setData(ch) {
	...
	if(ch.checked){//체크를했다면 주문자 정보를 받는자 정보에 대입
                            ...
                            <form id="checkout-form">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="member_name">주문고객명<span>*</span></label>
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="paymethod_id">결제방법 선택 <span>*</span></label>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>할인쿠폰</span> <span>-$10</span></li>
                                <li><span>총 결제금액</span> <span>$49.90</span></li>
                            </ul>
