...
public class MemberController {
	...
	public String regist(Member member) {
		...
		logger.debug("이메일sever"+member.getEmail_server());
	...
	public ModelAndView getLoginForm(HttpServletRequest resquest) {
	...
	public ModelAndView logout(HttpServletRequest request) {
		request.getSession().invalidate();//세션무효화, 이 시점부터 담겨진 데이턱 다 무효가 된다.
	...
	public ModelAndView handleException(MailSendException e) {
		...
		mav.addObject("msg",e.getMessage());//사용자가 보게 될 에러 메세지
